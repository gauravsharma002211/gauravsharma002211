                        ...
                        <Col lg={9} md={8}>
                            <div className='business-content'>
                                <div className='business-info' id='what-is-it'>
                                    ...
                                    <div className='info-img text-center'><img src={whatlsbop} className="img-fluid" /></div>
                                ...
                                <div className='business-info' id='who-is-it-for'>
                                    ...
                                    <div className='info-img text-center'><img src={BopInsurance} className="img-fluid" /></div>
                                ...
                                <div className='business-info' id='why-do-you-need-it'>
                                    <h2 className="title-wrp text-align-left">Why Do You Need a <span>Business Owners Policy?</span></h2>
                                    <div className='info-img text-center'><img src={Owners} className="img-fluid" /></div>
                                    <p>Usually, insurers won’t offer a BOP to companies that handle their business off-premises. Insurers
                                        usually have property parameters that go into their profile for a BOP and will not offer the policy packge
                                        to businesses that have more or less property than they are willing to cover.</p>
                                ...
                                <div className='business-info' id='what-does-it-cover'>
                                    <h2 className="title-wrp text-align-left">What’s <span>Covered?</span></h2>
                                    <div className='info-img text-center'><img src={DueDiligence} className="img-fluid" /></div>
                                    <p>Usually, insurers won’t offer a BOP to companies that handle their business off-premises. Insurers
                                        usually have property parameters that go into their profile for a BOP and will not offer the policy packge
                                        to businesses that have more or less property than they are willing to cover.</p>
                                    <p>Commercial property insurance will protect you in the event that your business property is damaged or
                                ...
                                <div className='business-info' id='what-doesnt-it-cover'>
                                    <h2 className="title-wrp text-align-left">What’s Not <span>Covered?</span></h2>
                                    <div className='info-img text-center'><img src={Covered} className="img-fluid" /></div>
                                    <p>Usually, insurers won’t offer a BOP to companies that handle their business off-premises. Insurers
                                        usually have property parameters that go into their profile for a BOP and will not offer the policy packge
                                        to businesses that have more or less property than they are willing to cover.</p>
                                    <p>Commercial property insurance will protect you in the event that your business property is damaged or
                                ...
                                <div className='business-info' id='what-does-it-cost'>
                                    <h2 className="title-wrp text-align-left">What Does a <span>Business Owners Policy</span> Cost?</h2>
